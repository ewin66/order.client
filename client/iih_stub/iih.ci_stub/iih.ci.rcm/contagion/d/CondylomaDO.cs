...
namespace iih.ci.rcm.contagion.d
{
    ...
    /// CondylomaDO 的摘要说明。
    /// </summary>
    public class CondylomaDO : BaseDO {

		public const string TABLE_NAME = "CI_MR_CONTAGION_CARD_CA";
		public const string TABLE_ALIAS_NAME = "a6";

        public CondylomaDO() {
        }
		public string Id_condyloma {
            get { return getAttrVal<string>("Id_condyloma",null); }
            set { setAttrVal<string>("Id_condyloma", value); }
        }
		...
		public string Id_hjsy {
            get { return getAttrVal<string>("Id_hjsy",null); }
            set { setAttrVal<string>("Id_hjsy", value); }
        }
		public string Code_hjsy {
            get { return getAttrVal<string>("Code_hjsy",null); }
            set { setAttrVal<string>("Code_hjsy", value); }
        }
		public string Name_hjsy {
            get { return getAttrVal<string>("Name_hjsy",null); }
            set { setAttrVal<string>("Name_hjsy", value); }
        }
		public string Id_hjdz {
            get { return getAttrVal<string>("Id_hjdz",null); }
            set { setAttrVal<string>("Id_hjdz", value); }
        }
		...
		public string Confirm_detection_date {
            get { return getAttrVal<string>("Confirm_detection_date",null); }
            set { setAttrVal<string>("Confirm_detection_date", value); }
        }
		...
		public string Marrycode {
            get { return getAttrVal<string>("Marrycode",null); }
            set { setAttrVal<string>("Marrycode", value); }
        }
		public string Marryname {
            get { return getAttrVal<string>("Marryname",null); }
            set { setAttrVal<string>("Marryname", value); }
        }
		...
		public string Hjsycode {
            get { return getAttrVal<string>("Hjsycode",null); }
            set { setAttrVal<string>("Hjsycode", value); }
        }
		public string Hjsyname {
            get { return getAttrVal<string>("Hjsyname",null); }
            set { setAttrVal<string>("Hjsyname", value); }
        }
        ...
        {
            return "iih.ci.rcm.contagion.d.CondylomaDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_condyloma", "Id_contagion", "Id_form", "Disease", "Disease_code", "Disease_name", "Is_aids_history", "Sd_aids_history", "Name_aids_history", "Id_contact_history", "Sd_contact_history", "Name_contact_history", "Id_infection_way", "Sd_infection_way", "Name_infection_way", "Id_sample_source", "Sd_sample_source", "Name_sample_source", "Id_conclusion", "Sd_conclusion", "Name_conclusion", "Is_alike", "Card_no", "Pat_name", "Parent_name", "Id_marry", "Code_marry", "Name_marry", "Id_culture", "Name_culture", "Code_culture", "Id_hjsy", "Code_hjsy", "Name_hjsy", "Id_hjdz", "Code_hjdz", "Name_hjdz", "Town", "Village", "House_no", "Dt_contagion", "Id_emp_entry", "Sd_emp_entry", "Name_emp_entry", "Id_nation", "Sd_nation", "Name_nation", "Confirm_detection_date", "Confirm_detection_unite", "Def1", "Code_disease", "Name_disease", "Sd_history_code", "Sd_history_name", "Contact_history_code", "Contact_history_name", "Infection_code", "Infection_name", "Sample_code", "Sample_name", "Conclusion_code", "Conclusion_name", "Marrycode", "Marryname", "Culturecode", "Culturename", "Hjsycode", "Hjsyname", "Areaname", "Areacode", "Doctorcode", "Doctorname", "Nation_code", "Nation_name"};
        }
