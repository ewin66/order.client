...
{
    /// <summary>
    /// AntibioticUseDO 的摘要说明。
    /// </summary>
    public class AntibioticUseDO : BaseDO {

        public AntibioticUseDO() {
        }
		public string Id_au {
		...
		public string Id_drug {
            get { return getAttrVal<string>("Id_drug",null); }
            set { setAttrVal<string>("Id_drug", value); }
        }
		public string Sd_drug {
            get { return getAttrVal<string>("Sd_drug",null); }
            set { setAttrVal<string>("Sd_drug", value); }
        }
		...
		public string Drug_code {
            get { return getAttrVal<string>("Drug_code",null); }
            set { setAttrVal<string>("Drug_code", value); }
        }
        ...
        {
            return "iih.ci.rcm.au.d.AntibioticUseDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_au", "Id_hospitalreport", "Isuseantibi", "Id_drug", "Sd_drug", "Name_drug", "Id_route_adminis", "Sd_route_adminis", "Name_route_adminis", "Dose", "Id_dose_unit", "Sd_dose_unit", "Name_dose_unit", "Usage", "Dt_start", "Dt_end", "Id_medi_methods", "Sd_medi_methods", "Name_medi_methods", "Id_objective", "Sd_objective", "Name_objective", "Id_treat_methods", "Sd_treat_methods", "Name_treat_methods", "Id_pre_methods", "Sd_pre_methods", "Name_pre_methods", "Is_pre_drug_use", "Id_pre_effect", "Sd_pre_effect", "Name_pre_effect", "Id_com_medi", "Sd_com_medi", "Name_com_medi", "Pre_medi_time", "Days_after_oper", "Adv_drug_reactions", "Double_infection", "Drug_code", "Drug_name", "Route_adminis_code", "Route_adminis_name", "Dose_unit_code", "Dose_unit_name", "Medi_methods_code", "Medi_methods_name", "Objective_code", "Objective_name", "Treat_methods_code", "Treat_methods_name", "Pre_methods_code", "Pre_methods_name", "Pre_effect_code", "Pre_effect_name", "Com_medi_code", "Com_medi_name"};
        }
