...
{
    public class IObspreMDOCrudServiceImpl : IObspreMDOCrudService
    {
        private string url   = XapSvrConfig.BaseUrl + "iihci.pre/iih.ci.pre.obspre.i.IObspreMDOCudService";//ConfigUtil.getServiceUrl();
        private string url_r = XapSvrConfig.BaseUrl + "iihci.pre/iih.ci.pre.obspre.i.IObspreMDORService";//ConfigUtil.getServiceUrl();
        ...
        /// 构造函数
        /// </summary>
        public IObspreMDOCrudServiceImpl()
        {
