...
namespace iih.ci.mr.nu.criticalillrec.d
{
    ...
    /// CriticalillDO 的摘要说明。
    /// </summary>
    public class CriticalillDO : BaseDO {

		public const string TABLE_NAME = "ci_mr_nu_ctri";
		public const string TABLE_ALIAS_NAME = "a0";

        public CriticalillDO() {
        }
        ...
        {
            return "iih.ci.mr.nu.criticalillrec.d.CriticalillDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_ctri", "Id_ent", "Id_sex", "Sd_sex", "Age", "Id_dep_phy", "Id_dep_nur", "Name_bed", "Code_amr_ip", "Name_diagnosis", "Id_org", "Id_grp", "Createdby", "Createdtime", "Modifiedby", "Modifiedtime", "Name_pat", "Name_sex", "Name_dep_phy", "Name_dep_nur"};
        }
		...
		protected override void setBdDataInfoNameMap() {
			if (base.name_path_map == null)
            {
				...
				base.name_path_map.Add("id","Id_ctri");
