...
{
    /// <summary>
    /// HealthyEduNsDO 的摘要说明。
    /// </summary>
    public class HealthyEduNsDO : BaseDO {

		public const string TABLE_NAME = "CI_MR_NU_HNER";
		public const string TABLE_ALIAS_NAME = "a0";

        public HealthyEduNsDO() {
        }
        ...
        {
            return "iih.ci.mr.nu.healthyedunsrec.d.HealthyEduNsDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_henr", "Id_grp", "Id_org", "Id_ent", "Id_sex", "Sd_sex", "Id_dep_nur", "Name_bed", "Code_amr_ip", "Code_entp", "Createdby", "Createdtime", "Modifiedby", "Modifiedtime", "Name_pat", "Name_sex", "Name_dep_nur"};
        }
