...
{
    /// <summary>
    /// OperNuRecordEqmDO 的摘要说明。
    /// </summary>
    public class OperNuRecordEqmDO : BaseDO {

		public const string TABLE_NAME = "ci_mr_nu_oprcod_eqm";
		public const string TABLE_ALIAS_NAME = "a1";

        public OperNuRecordEqmDO() {
        }
		public string Id_oprcod_eqm {
            get { return getAttrVal<string>("Id_oprcod_eqm",null); }
            set { setAttrVal<string>("Id_oprcod_eqm", value); }
        }
        ...
        {
            return "iih.ci.mr.nu.obstetrics.opernurecord.d.OperNuRecordEqmDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_oprcod_eqm", "Id_oprcod", "Id_eqmtp", "Sd_eqmtp", "Id_eqm", "Sd_eqm", "Num_oprbefor", "Num_befor", "Num_after", "Createdby", "Createdtime", "Modifiedby", "Modifiedtime", "Name_tp", "Name"};
        }
