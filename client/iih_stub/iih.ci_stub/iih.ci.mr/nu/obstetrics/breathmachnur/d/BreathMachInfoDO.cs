...
{
    /// <summary>
    /// BreathMachInfoDO 的摘要说明。
    /// </summary>
    public class BreathMachInfoDO : BaseDO {

		public const string TABLE_NAME = "CI_MR_NU_BTHMACH";
		public const string TABLE_ALIAS_NAME = "a0";

        public BreathMachInfoDO() {
        }
		...
		public DateTime? Dt_nurec {
            get { return getAttrVal<FDate>("Dt_nurec",null); }
            set { setAttrVal<FDate>("Dt_nurec", value); }
        }
        ...
        {
            return "iih.ci.mr.nu.obstetrics.breathmachnur.d.BreathMachInfoDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_bthmach", "Id_ent", "Id_pat", "Code_entp", "Id_org", "Id_grp", "Name_bed", "Code_amr_ip", "Age", "Dt_nurec", "Createdby", "Createdtime", "Modifiedby", "Modifiedtime", "Name_pat"};
        }
