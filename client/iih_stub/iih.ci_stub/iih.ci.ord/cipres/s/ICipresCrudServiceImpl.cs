...
//using iih.ci.ord.cipres.s.itf;
using xap.mw.core.utils;
using xap.mw.coreitf.d;
using xap.mw.serviceframework;
using xap.rui.appfw;
using xap.mw.core.data;using xap.sys.appfw.tmpl.qryscheme; 
...
{
    public class ICipresCrudServiceImpl : ICipresCrudService
    {
        private string url   = XapSvrConfig.BaseUrl + "iihci.ord/iih.ci.ord.cipres.i.ICipresCudService";//ConfigUtil.getServiceUrl();
        private string url_r = XapSvrConfig.BaseUrl + "iihci.ord/iih.ci.ord.cipres.i.ICipresRService";//ConfigUtil.getServiceUrl();
