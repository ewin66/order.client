...
{
    /// <summary>
    /// CiAppTreatSheetDO 的摘要说明。
    /// </summary>
    public class CiAppTreatSheetDO : BaseDO {

		public const string TABLE_NAME = "ci_app_treat";
		public const string TABLE_ALIAS_NAME = "a0";

        public CiAppTreatSheetDO() {
            this.Fg_bb = false;
            this.Fg_prn = false;
        ...
        {
            return "iih.ci.ord.app.d.CiAppTreatSheetDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_ciapptreatsheet", "Id_group", "Id_org", "Id_pat", "Id_entp", "Code_entp", "Id_en", "Fg_bb", "No_bb", "Code_app", "Name_app", "Id_dep_mp", "Id_emp_app", "Id_org_app", "Id_dep_app", "Dt_app", "Id_di", "Name_diag", "Id_diitm", "Str_id_diitm", "Str_code_di", "Str_name_di", "Fg_prn", "Cnt_prn", "Fg_hp", "Createdby", "Createdtime", "Modifiedby", "Modifiedtime", "Fg_hecominsur", "Hecominsurinfo", "Fg_prepay", "Fg_vip", "Fg_lishp", "Fg_hpbirth", "Researchinfo", "Fg_opspecial"};
        }
		...
		protected override void setBdDataInfoNameMap() {
			if (base.name_path_map == null)
            {
				...
				base.name_path_map.Add("id","Id_ciapptreatsheet");
