...
namespace iih.ci.ord.ciordems.d
{
    ...
    /// AddFeeDTO 的摘要说明。
    /// </summary>
    public class AddFeeDTO : BaseDTO
    {
        ...
        {
            return "iih.ci.ord.ciordems.d.AddFeeDTO";
        }
    }
}
