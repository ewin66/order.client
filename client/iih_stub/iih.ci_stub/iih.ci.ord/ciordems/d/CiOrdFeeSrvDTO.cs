...
{
    /// <summary>
    /// CiOrdFeeSrvDTO 的摘要说明。
    /// </summary>
    public class CiOrdFeeSrvDTO : BaseDTO {

        public CiOrdFeeSrvDTO() {
        ...
        /// 费用编码
        /// </summary>
        public string Fee_code_or
        {
            get { return getAttrVal<string>("Fee_code_or", null); }
            set { setAttrVal<string>("Fee_code_or", value); }
        }
        /// <summary>
        /// 医嘱内容
        /// </summary>
        ...
        public FArrayList BdHpIndicationList
        {
            get { return getAttrVal<FArrayList>("BdHpIndicationList", null); }
            set { setAttrVal<FArrayList>("BdHpIndicationList", value); }
        }
		...
		public int? Fg_hpindicjudged {
            get { return getAttrVal<int?>("Fg_hpindicjudged",null); }
        ...
        {
            return new string[]{ "Id_orsrv", "Id_or","Content_or", "Dt_effe", "Sortno", "Id_srv", "Id_srv_set", "Id_srvtp", "Sd_srvtp", "Code_srv", "Name_srv", "Id_srvca", "Id_unit_med", "Name_unit_med", "Quan_med", "Price", "Id_freq", "Name_freq", "Id_route", "Name_route", "Name_routedes", "Id_routedes", "Id_boil", "Id_boildes", "Name_boil", "Name_boildes", "Fg_dose_anoma", "Des_srv", "Fg_mm", "Fg_set", "Fg_or", "Fg_bl", "Fg_self", "Fg_outp", "Fg_treat", "Fg_propc", "Id_org_srv", "Id_ward_srv", "Id_dep_srv", "Id_emp_srv", "Id_dep", "Dt_create_srv", "Name_dep", "Dt_last_bl", "Eu_blmd", "Id_orsrvmm", "Id_mm", "Code_mm", "Spec_mm", "Name_mm", "Id_unit_sale", "Name_unit_sale", "Name_unit_base", "Id_unit_base", "Quan_num_base", "Price_cur", "Quan_den_base", "Quan_cur", "Quan_base", "Quan_bed_medu", "Factor_cb", "Factor_mb", "Id_dosage", "Sd_dosage", "Id_pharm", "Sd_pharm", "Id_pois", "Sd_pois", "Id_anti", "Sd_anti", "Id_mmtp", "Sd_mmtp", "Sd_val", "Id_val", "Indica", "Constr", "React", "Guide", "Fg_otc", "Emsfreqdose", "Id_body", "Sd_body", "Body_name", "Id_pos", "Sd_pos", "Pos_name", "Fg_indic", "Eu_sourcemd", "Srv_sv", "Mm_sv", "Fg_skintest", "Id_skintest_skip_reason", "Sd_skintest_skip_reason", "Sd_reltp", "Id_reltp", "Id_or_rel", "Fg_skintest_rst", "Fg_selfsrv", "Id_srv_src", "Quan_total_medu", "Fg_selfpay", "Id_primd", "Id_hp", "Name_hp", "Id_hpsrvtp", "Sd_hpsrvtp", "Id_dep_wh", "Emsagentinfo", "Innercode_srvca", "Frequnitct", "Sd_frequnitct", "Freqct", "Name_hpsrvtp", "Limit", "Amt_total", "Name_dep_wh", "Id_unit_cg", "Name_unit_cg", "Quan_cgbase", "Factor_cm", "Sd_roundmd_cg", "Id_sup", "Name_mmtp", "Name_sup", "Sd_roundmd", "Amt_cur", "Quan_stock", "Id_srvskin", "Mapkeys", "Mapinfo", "Priby", "Fg_base", "Days_available", "Fg_hpindicjudged", "Fg_feertnable"};
        }
        ...
        {
            return "iih.ci.ord.ciordems.d.CiOrdFeeSrvDTO";
        }
    }
}
