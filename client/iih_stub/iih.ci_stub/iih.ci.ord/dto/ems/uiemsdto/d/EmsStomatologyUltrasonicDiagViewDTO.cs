...
{
    /// <summary>
    /// EmsStomatologyUltrasonicDiagViewDTO 的摘要说明。
    /// </summary>
    public class EmsStomatologyUltrasonicDiagViewDTO : BaseDTO {

        public EmsStomatologyUltrasonicDiagViewDTO() {
        ...
        {
            return new string[]{ "Id_or", "Id_srv", "Name_srv", "Fg_urgent", "Price", "Sd_srvtp", "Id_dep_mp", "Name_dep_mp", "Filter_dep_mp", "Dt_plan", "No_applyform", "Id_pps", "Sd_pps", "Name_pps", "Id_di", "Name_di", "Clinicalzztz", "Setitem", "Des_pps", "Sv", "Fg_set", "Emsrisviewitems", "Fg_radio"};
        }
        ...
        {
            return "iih.ci.ord.dto.ems.uiemsdto.d.EmsStomatologyUltrasonicDiagViewDTO";
        }
    }
}
