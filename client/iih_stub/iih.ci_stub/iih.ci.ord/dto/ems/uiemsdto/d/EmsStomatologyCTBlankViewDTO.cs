...
{
    /// <summary>
    /// EmsStomatologyCTBlankViewDTO 的摘要说明。
    /// </summary>
    public class EmsStomatologyCTBlankViewDTO : BaseDTO {

        public EmsStomatologyCTBlankViewDTO() {
		...
		public string Consentform {
            get { return getAttrVal<string>("Consentform",null); }
            set { setAttrVal<string>("Consentform", value); }
        }
        ...
        {
            return new string[]{ "Id_or", "Id_srv", "Name_srv", "Fg_urgent", "Price", "Sd_srvtp", "Id_dep_mp", "Name_dep_mp", "Filter_dep_mp", "Dt_plan", "No_applyform", "Id_pps", "Sd_pps", "Name_pps", "Id_di", "Name_di", "Clinicalzztz", "Setitem", "Consentform", "Sv", "Fg_set", "Emsrisviewitems", "Fg_radio"};
        }
        ...
        {
            return "iih.ci.ord.dto.ems.uiemsdto.d.EmsStomatologyCTBlankViewDTO";
        }
    }
}
