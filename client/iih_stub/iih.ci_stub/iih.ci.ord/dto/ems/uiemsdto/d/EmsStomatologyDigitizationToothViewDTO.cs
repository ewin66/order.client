...
{
    /// <summary>
    /// EmsStomatologyDigitizationToothViewDTO 的摘要说明。
    /// </summary>
    public class EmsStomatologyDigitizationToothViewDTO : BaseDTO {

        public EmsStomatologyDigitizationToothViewDTO() {
		...
		public string Toothmap {
            get { return getAttrVal<string>("Toothmap",null); }
            set { setAttrVal<string>("Toothmap", value); }
        }
        ...
        {
            return new string[]{ "Id_or", "Id_srv", "Name_srv", "Fg_urgent", "Price", "Sd_srvtp", "Id_dep_mp", "Name_dep_mp", "Filter_dep_mp", "Dt_plan", "No_applyform", "Id_pps", "Sd_pps", "Name_pps", "Id_di", "Name_di", "Clinicalzztz", "Setitem", "Toothmap", "Sv", "Fg_set", "Emsrisviewitems", "Fg_radio"};
        }
        ...
        {
            return "iih.ci.ord.dto.ems.uiemsdto.d.EmsStomatologyDigitizationToothViewDTO";
        }
    }
}
