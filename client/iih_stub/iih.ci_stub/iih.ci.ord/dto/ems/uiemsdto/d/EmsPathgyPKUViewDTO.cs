...
{
    /// <summary>
    /// EmsPathgyPKUViewDTO 的摘要说明。
    /// </summary>
    public class EmsPathgyPKUViewDTO : BaseDTO {

        public EmsPathgyPKUViewDTO() {
		...
		public DateTime? Opdate {
            get { return getAttrVal<FDateTime>("Opdate",null); }
            set { setAttrVal<FDateTime>("Opdate", value); }
        }
        ...
        {
            return new string[]{ "Id_or", "Id_srv", "Name_srv", "Details", "Id_samptp", "Sd_samptp", "Name_samptp", "Id_di", "Name_di", "Id_diitm", "Fg_urgent", "No_pathgy", "Id_dep_mp", "Name_dep_mp", "Price", "Des_sympsign", "Mensthis", "Opdate", "Fg_outer", "Org_pathgy_old", "No_pathgy_old", "Dt_pathgy_old", "Di_pathgy_old", "Collectdes", "Id_emp", "Name_emp", "Dt_coll", "Sv", "Fg_set", "Emspathgyitems", "Fg_radio"};
        }
        ...
        {
            return "iih.ci.ord.dto.ems.uiemsdto.d.EmsPathgyPKUViewDTO";
        }
    }
}
