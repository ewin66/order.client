...
{
    /// <summary>
    /// EmsStomatologyCBCTNEWViewDTO 的摘要说明。
    /// </summary>
    public class EmsStomatologyCBCTNEWViewDTO : BaseDTO {

        public EmsStomatologyCBCTNEWViewDTO() {
		...
		public string Phenomenon {
            get { return getAttrVal<string>("Phenomenon",null); }
            set { setAttrVal<string>("Phenomenon", value); }
        }
        ...
        /// </summary>
		public bool? Record {
            get { return getAttrVal<FBoolean>("Record",null); }
            set { setAttrVal<FBoolean>("Record", value); }
        }
        ...
        /// </summary>
		public bool? Output {
            get { return getAttrVal<FBoolean>("Output",null); }
            set { setAttrVal<FBoolean>("Output", value); }
        }
        ...
        /// </summary>
		public bool? Report {
            get { return getAttrVal<FBoolean>("Report",null); }
            set { setAttrVal<FBoolean>("Report", value); }
        }
		...
		public string Explain {
            get { return getAttrVal<string>("Explain",null); }
            set { setAttrVal<string>("Explain", value); }
        }
        ...
        {
            return new string[]{ "Id_or", "Id_srv", "Name_srv", "Fg_urgent", "Price", "Sd_srvtp", "Id_dep_mp", "Name_dep_mp", "Filter_dep_mp", "Dt_plan", "No_applyform", "Id_pps", "Sd_pps", "Name_pps", "Id_di", "Name_di", "Clinicalzztz", "Setitem", "Phenomenon", "Record", "Output", "Report", "Explain", "Sv", "Fg_set", "Emsrisviewitems", "Fg_radio"};
        }
        ...
        {
            return "iih.ci.ord.dto.ems.uiemsdto.d.EmsStomatologyCBCTNEWViewDTO";
        }
    }
}
