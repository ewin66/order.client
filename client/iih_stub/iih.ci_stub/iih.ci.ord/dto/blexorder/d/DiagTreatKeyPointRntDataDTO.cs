...
namespace iih.ci.ord.dto.blexorder.d
{
    ...
    /// </summary>
    public class DiagTreatKeyPointRntDataDTO : BaseDTO {

        public DiagTreatKeyPointRntDataDTO()
        {
         ...
         * @return String
         */
        public FDate Dt_keypoint
        {
            get { return getAttrVal<FDate>("Dt_keypoint", null); }
            set { setAttrVal<FDate>("Dt_keypoint", value); }
        }
        /// <summary>
        /// 诊疗视图数据主键
        /// </summary>
        ...
        {
            return new string[] { "Id_diagtreat", "Drugdata", "Labdata", "Obsdata", "Bodysignsdata", "Id_en", "Dt_start", "Dt_end", "Cimrs" };
        }
        ...
        {
            return "iih.ci.ord.dto.blexorder.d.DiagTreatKeyPointRntDataDTO";
        }
    }
}
