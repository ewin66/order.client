...
namespace iih.ci.ord.cior.d
{
    ...
    /// OrdApObsDO 的摘要说明。
    /// </summary>
    public class OrdApObsDO : BaseDO {
		...
		public string Name_su_obs {
            get { return getAttrVal<string>("Name_su_obs",null); }
            set { setAttrVal<string>("Name_su_obs", value); }
        }
        public int Ds {
        ...
        {
            return "iih.ci.ord.cior.d.OrdApObsDO";
        }
        ...
        {
            return new string[]{"Ds","Sv",  "Id_orobs", "Id_or", "Id_di", "Name_diag", "Str_code_di", "Str_name_di", "No_applyform", "Dt_plan", "Biopsy", "Des_sympsign", "Clinicalzztz", "Pastillness", "Auximtexam", "Fg_urgent", "Announcements", "Id_pps", "Sd_pps", "Des_pps", "Id_su_obs", "Sd_su_obs", "Createdby", "Createdtime", "Modifiedby", "Modifiedtime", "Str_id_diitm", "Def1", "Def2", "Def3", "Def4", "Def5", "Def6", "Def7", "Def8", "Def9", "Def10", "Def11", "Def12", "Def13", "Def14", "Def15", "Def16", "Def17", "Def18", "Def19", "Def20", "Def21", "Def22", "Def23", "Def24", "Def25", "Def26", "Def27", "Def28", "Def29", "Def30", "Def31", "Def32", "Def33", "Def34", "Def35", "Def36", "Def37", "Def38", "Def39", "Def40", "Def41", "Def42", "Def43", "Def44", "Def45", "Def46", "Def47", "Def48", "Def49", "Def50", "Id_diitm", "Fg_prn", "Cnt_prn", "Name_di", "Name_pps", "Name_su_obs"};
        }
