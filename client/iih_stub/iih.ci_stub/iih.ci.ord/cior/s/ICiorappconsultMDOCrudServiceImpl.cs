...
{
    public class ICiorappconsultMDOCrudServiceImpl : ICiorappconsultMDOCrudService
    {
        private string url   = XapSvrConfig.BaseUrl + "iihci.ord/iih.ci.ord.cior.i.ICiorappconsultMDOCudService";//ConfigUtil.getServiceUrl();
        private string url_r = XapSvrConfig.BaseUrl + "iihci.ord/iih.ci.ord.cior.i.ICiorappconsultMDORService";//ConfigUtil.getServiceUrl();
        ...
        /// 构造函数
        /// </summary>
        public ICiorappconsultMDOCrudServiceImpl()
        {
        ...
        /// <returns>OrdApConsDO[]</return>
        public OrdApConsDO[] findByAttrValString(string attr, string value)
        {
            List<object> param = new List<object>();
            param.Add(attr);
            param.Add(value);
            si.url=url_r;
            OrdApConsDO[] rtn = si.invokeList<OrdApConsDO>("findByAttrValString", param.ToArray());
            return rtn;
        }
        ...
        /// <returns>OrdApConsDO[]</return>
        public OrdApConsDO[] findByAttrValStrings(string attr, string[] values)
        {
            List<object> param = new List<object>();
            param.Add(attr);
            param.Add(values);
            si.url=url_r;
            OrdApConsDO[] rtn = si.invokeList<OrdApConsDO>("findByAttrValStrings", param.ToArray());
            return rtn;
        }
        ...
        /// <param name="values"></param>
        /// <returns>OrdApConsDO[]</return>
        public OrdApConsDO[] findByAttrValList(string attr, FArrayList values)
        {
            List<object> param = new List<object>();
            param.Add(attr);
            param.Add(values);
            si.url=url_r;
            OrdApConsDO[] rtn = si.invokeList<OrdApConsDO>("findByAttrValList", param.ToArray());
            return rtn;
        }
        ...
        /// <param name="orderStr"></param>
        /// <param name="pg"></param>
        public PagingRtnData<OrdApConsDO> findByQCondAndPageInfo(QryRootNodeDTO qryRootNodeDTO,String orderStr,PaginationInfo pg)
        {
            List<object> param = new List<object>();
	    	param.Add(qryRootNodeDTO);
	    	param.Add(orderStr);
       		param.Add(pg);
            si.url = url_r;
            PagingRtnData<OrdApConsDO> rtn = si.invokePaging<OrdApConsDO>("findByQCondAndPageInfo", param.ToArray());
            return rtn;
        }
    }
}