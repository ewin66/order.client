...
{
    public class IOrdSrvDOCrudServiceImpl : IOrdSrvDOCrudService
    {
        private string url   = XapSvrConfig.BaseUrl + "iihci.ord/iih.ci.ord.ciorder.i.IOrdSrvDOCudService";//ConfigUtil.getServiceUrl();
        private string url_r = XapSvrConfig.BaseUrl + "iihci.ord/iih.ci.ord.ciorder.i.IOrdSrvDORService";//ConfigUtil.getServiceUrl();
        ...
        /// 构造函数
        /// </summary>
        public IOrdSrvDOCrudServiceImpl()
        {
        ...
        /// <returns>OrdSrvDO[]</return>
        public OrdSrvDO[] findByAttrValString(string attr, string value)
        {
            List<object> param = new List<object>();
            param.Add(attr);
            param.Add(value);
            si.url=url_r;
            OrdSrvDO[] rtn = si.invokeList<OrdSrvDO>("findByAttrValString", param.ToArray());
            return rtn;
        }
        ...
        /// <returns>OrdSrvDO[]</return>
        public OrdSrvDO[] findByAttrValStrings(string attr, string[] values)
        {
            List<object> param = new List<object>();
            param.Add(attr);
            param.Add(values);
            si.url=url_r;
            OrdSrvDO[] rtn = si.invokeList<OrdSrvDO>("findByAttrValStrings", param.ToArray());
            return rtn;
        }
        ...
        /// <param name="values"></param>
        /// <returns>OrdSrvDO[]</return>
        public OrdSrvDO[] findByAttrValList(string attr, FArrayList values)
        {
            List<object> param = new List<object>();
            param.Add(attr);
            param.Add(values);
            si.url=url_r;
            OrdSrvDO[] rtn = si.invokeList<OrdSrvDO>("findByAttrValList", param.ToArray());
            return rtn;
        }
        ...
        /// <param name="orderStr"></param>
        /// <param name="pg"></param>
        public PagingRtnData<OrdSrvDO> findByQCondAndPageInfo(QryRootNodeDTO qryRootNodeDTO,String orderStr,PaginationInfo pg)
        {
            List<object> param = new List<object>();
        	param.Add(qryRootNodeDTO);
        	param.Add(orderStr);
        	param.Add(pg);
        	si.url = url_r;
        	PagingRtnData<OrdSrvDO> rtn = si.invokePaging<OrdSrvDO>("findByQCondAndPageInfo", param.ToArray());
        	return rtn;
        }
    }
}