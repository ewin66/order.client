...
namespace iih.ci.ord.cfg.dto.msg.d
{
    ...
    /// RuleMsgDTO 的摘要说明。
    /// </summary>
    public class RuleMsgDTO : BaseDTO {
        ...
        /// 扩展信息
        /// </summary>
		public FMap Ext_content {
            get { return getAttrVal<FMap>("Ext_content",null); }
            set { setAttrVal<FMap>("Ext_content", value); }
        }
        /// <summary>
        /// 返回属性列表
        /// </summary>
        ...
        {
            return new string[]{ "Msg_code", "Msg_type", "Module_code", "Module_name", "Content", "Ext_content"};
        }
        ...
        {
            return "iih.ci.ord.cfg.dto.msg.d.RuleMsgDTO";
        }
    }
}
