...
{
    public partial class ConsReviewGridView : XapListControl
    {
        ...
        private string type = CiDictCodeConst.CONS_DEPREVIEW;

        public ConsReviewGridView()
        {
            InitializeComponent();
        ...
        protected override void OnFillData()
        {
            ...
            file.FormId = CiOrdBillFormTmplConst.CIORD_IP_ConsReviewGridView;// "20160614042319866I6M";
        ...
        void btnAgree_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (dto.Sd_su_cons != CiDictCodeConst.SD_CIDI_DKSSP)
            {
                this.ShowInfo(string.Format("该会诊医务科已审批！"));
                return;
            }
        ...
        void xapFormControl_AfterFocused(object sender, DataFocusedEventArgs e)
        {
            ...
            if (consDto.Sd_su_cons == CiDictCodeConst.SD_CIDI_DKSSP)
            {
        ...
        public override void HandleState(object sender, DictionaryEventArgs eventArgs)
        {
            ...
            {
                case UIEvent.EDIT:
                    this.xapFormControl.Enabled = false;
                    break;
                case UIEvent.SAVE_SUCCESS:
                case UIEvent.CANCEL:
                    this.xapFormControl.Enabled = true;
                    this.FireSelected(consDto);
                    break;
                case "Query":
                    this.xapFormControl.Enabled = true;
