...
{
    public partial class ConResInfoView : XapBaseControl
    {

        #region 构造函数区域
        public ConResInfoView()
        {
        ...
        protected override void OnFillData()
        {
            ...
            file.FormId = CiOrdBillFormTmplConst.CIORD_IP_ConResInfoView;// "20151116111338082SE7";
