...
{public partial class TakeDrugOutPresView : CiorderBaseControl
    {
        ...
        {
          //  gv = xapFormControl1.GetGridView("preslist");
       ...
       XapFormControl xapFormControl1;
        ...
        protected override void OnFillData()
        {
            ...
            file.FormId = CiOrdBillFormTmplConst.CIORD_IP_TakeDrugOutPresView;// "20151123024924760NRU";
        ...
        void TakeDrugOutPresView_Load(object sender, EventArgs e)
        {
            this.OnInit();
        }
