...
namespace xap.cli.sdk.render
{
    ...
    {
        private static LogManagerEX logManager;
        static Log()
        {
            logManager = new LogManagerEX();
        }
    ...
    public class LogManagerEX
    {
        ...
        public LogManagerEX(string logPath, string logFileExtName, bool writeLogTime)
        {
