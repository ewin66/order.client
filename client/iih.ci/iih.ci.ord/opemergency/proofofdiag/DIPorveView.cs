...
{
    public partial class DIPorveView : XapListControl, IWorkStationRegist
    {
       ...
       // public PatiVisitDO patDo = null;
        ...
        public DIPorveView(Ent4BannerDTO ent4BannerDto) :this()
        {
...
/// 获取控件相关的数据，不涉及界面(不读写界面元素）。
        ...
        protected override void OnFillData()
        {
            ...
            {
                file.FormId = CiOrdBillFormTmplConst.CIORD_OP_DIPorveView;// "20151218040558955A4B";
            }
            else
            {
                file.FormId = CiOrdBillFormTmplConst.CIORD_IP_DIPorveView;// "20151120040106530KAR";
            }
	...
	//prt_logic.doPrint(true);
      //   string str =   prt_logic.getLastErrMsg();
            // 在模板中加载新数据
