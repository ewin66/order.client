...
namespace iih.ci.ord.opemergency.assi.entdi.view
{
    ...
    /// <para>类 名 称 :  EntDiInfectAssiView					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  Administrator         				</para> 
    /// <para>修 改 人 :  Administrator         				</para> 
    /// <para>创建时间 :  2017/4/11 11:42:56             </para>
    /// <para>更新时间 :  2017/4/11 11:42:56             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2017. All rights reserved.</para> 
    /// </summary>
    public class EntDiInfectAssiView : EntDiAssiView
    {
        public EntDiInfectAssiView()
            : base()
        { }
