...
{
    public partial class OpMedSrvClassButton : XapBaseControl
    {
        ...
        /// 医嘱模板内容显示
        /// </summary>
        private OpmedSrvRadioView templateListView;

        public OpMedSrvClassButton()
        {
            InitializeComponent();
        ...
        {
            templateListView = this.Context.Config.GetInstance("OpmedSrvRadioView") as OpmedSrvRadioView;
