...
namespace iih.ci.ord.opemergency.action.statehandler
{
    ...
    /// <para>类 名 称 :  OpCurrOrderDeleteHandler					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  Administrator         				</para> 
    /// <para>修 改 人 :  Administrator         				</para> 
    /// <para>创建时间 :  2017/8/23 9:50:53             </para>
    /// <para>更新时间 :  2017/8/23 9:50:53             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2017. All rights reserved.</para> 
    /// </summary>
    public class OpCurrOrderDeleteHandler : IXStateHandler
    {
