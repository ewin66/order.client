...
{
    /// <summary>
    /// <para>描    述 :  诊毕、撤回触发校验医嘱		</para>
    /// <para>说    明 :                     			</para>
    /// <para>项目名称 :  iih.ci.ord.opemergency.operateaction.opcomplete.view    </para>    
    /// <para>类 名 称 :  CiOrCompleteCheckAction					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  Administrator         				</para> 
    /// <para>修 改 人 :  Administrator         				</para> 
    /// <para>创建时间 :  2017/10/31 18:55:57             </para>
    /// <para>更新时间 :  2017/10/31 18:55:57             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2017. All rights reserved.</para> 
    /// </summary>
    public class CiOrCompleteCheckAction : AbstractActionHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            this.FireBizEventSent(this, OpActionConstant.OP_COMPLETE_OR_SEND_ACTION, OpActionConstant.OP_COMPLETE_OR_RECEIVE_ACTION, null);
        }
        ...
        {
            if (dataDic.ContainsKey(OpActionConstant.OP_COMPLETE_OR_RECEIVE_ACTION))
            {
