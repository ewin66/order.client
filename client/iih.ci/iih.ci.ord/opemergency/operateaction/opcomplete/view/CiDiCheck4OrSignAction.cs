...
namespace iih.ci.ord.opemergency.operateaction.opcomplete.view
{
    ...
    /// <para>类 名 称 :  CiDiCheck4OrSignAction					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  Administrator         				</para> 
    /// <para>修 改 人 :  Administrator         				</para> 
    /// <para>创建时间 :  2017/10/31 17:10:54             </para>
    /// <para>更新时间 :  2017/10/31 17:10:54             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2017. All rights reserved.</para> 
    /// </summary>
    public class CiDiCheck4OrSignAction : AbstractActionHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            this.FireBizEventSent(this, OpActionConstant.OP_DI_SEND_OR_SIGN_ACTION, OpActionConstant.OP_DI_RECEIVE_OR_SIGN_ACTION, null);
        }
        ...
        {
            if (dataDic.ContainsKey(OpActionConstant.OP_DI_RECEIVE_OR_SIGN_ACTION))
            {
