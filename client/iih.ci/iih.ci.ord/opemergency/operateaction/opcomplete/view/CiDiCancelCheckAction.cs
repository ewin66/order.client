...
{
    /// <summary>
    /// <para>描    述 :  取消接诊触发校验诊断		</para>
    /// <para>说    明 :                     			</para>
    /// <para>项目名称 :  iih.ci.ord.opemergency.operateaction.opcomplete.view    </para>    
    /// <para>类 名 称 :  CiDiCancelCheckAction					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  Young         				</para> 
    /// <para>修 改 人 :  Young         				</para> 
    /// <para>创建时间 :  2017/10/26 19:00:55             </para>
    /// <para>更新时间 :  2017/10/26 19:00:55             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2017. All rights reserved.</para> 
    /// </summary>
    public class CiDiCancelCheckAction : AbstractActionHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            this.FireBizEventSent(this, OpActionConstant.OP_CANCEL_DI_SEND_ACTION, OpActionConstant.OP_CANCEL_DI_RECEIVE_ACTION, null);
        }
        ...
        {
            if (dataDic.ContainsKey(OpActionConstant.OP_CANCEL_DI_RECEIVE_ACTION))
            {
