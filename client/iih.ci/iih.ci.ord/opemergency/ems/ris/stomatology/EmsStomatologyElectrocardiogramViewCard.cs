...
namespace iih.ci.ord.opemergency.ems
{
    ...
    /// </summary>
    public partial class EmsStomatologyElectrocardiogramViewCard : EmsRisViewCard
    {
        #region 构造函数区域
        ...
        {
            this.SetFormId(CiOrdBillFormTmplConst.CIORD_OP_EmsStomatologyElectrocardiogramViewCard/*"20170630023026752000"*/);
        }
