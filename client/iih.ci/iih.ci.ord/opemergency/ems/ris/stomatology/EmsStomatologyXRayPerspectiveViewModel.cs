...
namespace iih.ci.ord.opemergency.ems.dp
{
    ...
    /// </summary>
    class EmsStomatologyXRayPerspectiveViewModel : EmsRisViewModel
    {
        #region 构造函数
        public EmsStomatologyXRayPerspectiveViewModel(Ent4BannerDTO ent)
            : base(ent) 
        {
