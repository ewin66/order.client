...
namespace iih.ci.ord.opemergency.ems
{
    ...
    /// </summary>
    public partial class EmsStomatologyGeneralXRayViewCard : EmsRisViewCard
    {
        #region 构造函数区域
        public EmsStomatologyGeneralXRayViewCard(IEventDelegate owner)
            : base(owner)
        {
        }
        #endregion
        ...
        {
            this.SetFormId(CiOrdBillFormTmplConst.CIORD_OP_EmsStomatologyGeneralXRayViewCard/*"20170629084941864000"*/);
        }
