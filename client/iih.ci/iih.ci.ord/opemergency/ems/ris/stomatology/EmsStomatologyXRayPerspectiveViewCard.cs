...
namespace iih.ci.ord.opemergency.ems
{
    ...
    /// </summary>
    public partial class EmsStomatologyXRayPerspectiveViewCard : EmsRisViewCard
    {
        #region 构造函数区域
        public EmsStomatologyXRayPerspectiveViewCard(IEventDelegate owner)
            : base(owner)
        {
        ...
        {
            this.SetFormId(CiOrdBillFormTmplConst.CIORD_OP_EmsStomatologyXRayPerspectiveViewCard/*"20160914050959246000"*/);
        }
        ...
        protected override void OnXapFormControl_ModelFilled(object sender, EventArgs e)
       {
            ...
            {
                EmsStomatologyXRayPerspectiveViewModel tmpModel = this.GetViewModel() as EmsStomatologyXRayPerspectiveViewModel;
