...
namespace iih.ci.ord.opemergency.ems
{
    ...
    /// </summary>
    public partial class EmsStomatologyUltrasonicViewCard : EmsRisViewCard
    {
        ...
        {
            this.SetFormId(CiOrdBillFormTmplConst.CIORD_OP_EmsStomatologyUltrasonicViewCard/*"20160914075218010000"*/);
        }
        ...
        protected override void OnXapFormControl_ModelFilled(object sender, EventArgs e)
        {
            ...
            {
                EmsStomatologyUltrasonicViewModel tmpModel = this.GetViewModel() as EmsStomatologyUltrasonicViewModel;
