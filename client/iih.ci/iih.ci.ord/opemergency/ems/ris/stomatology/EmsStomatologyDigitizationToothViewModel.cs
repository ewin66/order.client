...
{
    /// <summary>
    /// <para>描    述 : XRay数字化牙片【00010733】数据处理模型                </para> 
    ...
    /// </summary>
    class EmsStomatologyDigitizationToothViewModel : EmsRisViewModel
    {
        #region 构造函数
        public EmsStomatologyDigitizationToothViewModel(Ent4BannerDTO ent)
            : base(ent) 
        {
