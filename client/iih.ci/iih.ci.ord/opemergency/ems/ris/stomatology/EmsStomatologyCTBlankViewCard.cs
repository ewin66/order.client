...
namespace iih.ci.ord.opemergency.ems
{
    ...
    /// </summary>
    public partial class EmsStomatologyCTBlankViewCard : EmsRisViewCard
    {
        #region 构造函数区域
        public EmsStomatologyCTBlankViewCard(IEventDelegate owner)
            : base(owner)
        {
        }
        #endregion
        ...
        {
            this.SetFormId(CiOrdBillFormTmplConst.CIORD_OP_EmsStomatologyCTBlankViewCard/*"20170630022607284000"*/);
        }
