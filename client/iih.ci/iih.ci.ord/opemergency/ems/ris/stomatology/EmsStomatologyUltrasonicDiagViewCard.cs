...
namespace iih.ci.ord.opemergency.ems
{
    ...
    /// </summary>
    public partial class EmsStomatologyUltrasonicDiagViewCard : EmsRisViewCard
    {
        #region 构造函数区域
        public EmsStomatologyUltrasonicDiagViewCard(IEventDelegate owner)
            : base(owner)
        {
        }
        #endregion
        ...
        {
            this.SetFormId(CiOrdBillFormTmplConst.CIORD_OP_EmsStomatologyUltrasonicDiagViewCard/*"20170629084116198000"*/);
        }
