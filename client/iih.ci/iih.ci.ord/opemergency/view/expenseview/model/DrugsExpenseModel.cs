...
{
    /// <summary>
    /// <para>描    述 :  药品费用模型      			</para>
    /// <para>说    明 :                     			</para>
    /// <para>项目名称 :  iih.ci.ord.opemergency.view.expenseview.model    </para>    
    /// <para>类 名 称 :  DrugsExpenseModel					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  qzwang         				</para> 
    /// <para>修 改 人 :  qzwang         				</para> 
    /// <para>创建时间 :  2016/7/12 13:27:11             </para>
    /// <para>更新时间 :  2016/7/12 13:27:11             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2016. All rights reserved.</para> 
    /// </summary>
    public class DrugsExpenseModel : ExpenseModel
    {
        public DrugsExpenseModel(XapDataList<EmsOrDrug> ds)
            : base(ds)
        {
