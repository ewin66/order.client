...
namespace iih.ci.ord.opemergency.emsfactory
{
    ...
    /// </summary>
    public class EmsStomatologyXRayPerspectiveDriver : EmsRisDriver
    {
        protected override BaseEmsViewModel CreateEmsModel(en.pv.dto.d.Ent4BannerDTO e)
        {
            if (null != e)
            {
                return new EmsStomatologyXRayPerspectiveViewModel(e);
            }
            return null;
        }
        ...
        protected override ems.common.BaseEmsView CreateEmsView(IEventDelegate o)
        {
            if (null != o)
            {
                return new TrOrderStomatologyXRayPerspectiveView(o);
            }
            return null;
        }
    }
