...
namespace iih.ci.ord.opemergency.emsfactory
{
    ...
    /// </summary>
    public class EmsStomatologyUltrasonicDiagViewDriver : EmsRisDriver
    {
        protected override BaseEmsViewModel CreateEmsModel(en.pv.dto.d.Ent4BannerDTO e)
        {
            if (null != e)
            {
                return new EmsStomatologyUltrasonicDiagViewModel(e);
            }
            return null;
        }
        ...
        protected override ems.common.BaseEmsView CreateEmsView(IEventDelegate o)
        {
            if (null != o)
            {
                return new TrOrderStomatologyUltrasonicDiagView(o);
            }
            return null;
        }
    }
