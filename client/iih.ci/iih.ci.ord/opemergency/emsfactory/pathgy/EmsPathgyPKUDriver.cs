...
namespace iih.ci.ord.opemergency.emsfactory
{
    ...
    /// <para>类 名 称 :  EmsPathgyPKUDriver					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  Administrator         				</para> 
    /// <para>修 改 人 :  Administrator         				</para> 
    /// <para>创建时间 :  2017/3/31 11:24:40             </para>
    /// <para>更新时间 :  2017/3/31 11:24:40             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2017. All rights reserved.</para> 
    /// </summary>
    public class EmsPathgyPKUDriver : EmsPathgyDriver
    {
        protected override BaseEmsViewModel CreateEmsModel(en.pv.dto.d.Ent4BannerDTO e)
        {
            if (null != e)
            {
                return new EmsPathgyPKUViewModel(e);
            }
            return null;
        }
        ...
        protected override ems.common.BaseEmsView CreateEmsView(IEventDelegate o)
        {
            if (null != o)
            {
                return new TrOrderPathgyPKUView(EnumPathyCardTp.PKU, o);
            }
            return null;
        }
    }
