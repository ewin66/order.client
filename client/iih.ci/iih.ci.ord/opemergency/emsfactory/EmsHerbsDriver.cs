...
{
    /// <summary>
    /// <para>描    述 :  草药医疗单驱动    			</para>
    /// <para>说    明 :                     			</para>
    /// <para>项目名称 :  iih.ci.ord.opemergency.emsfactory    </para>    
    /// <para>类 名 称 :  EmsHerbsDriver					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  qzwang         				</para> 
    /// <para>修 改 人 :  qzwang         				</para> 
    /// <para>创建时间 :  2016/7/19 8:41:58             </para>
    /// <para>更新时间 :  2016/7/19 8:41:58             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2016. All rights reserved.</para> 
    /// </summary>
    public class EmsHerbsDriver : BaseEmsDriver
    {
        protected override BaseEmsViewModel CreateEmsModel(en.pv.dto.d.Ent4BannerDTO e)
        {
            if (e != null)
            {
                return new EmsHerbsViewModel(e);
            }
            return null;
        }
