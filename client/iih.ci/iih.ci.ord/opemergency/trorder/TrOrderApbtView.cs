...
{
    /// <summary>
    /// <para>描    述 :  备血医疗单视图                   			</para>
    /// <para>说    明 :  简洁                   			</para>
    /// <para>项目名称 :  iih.ci.ord.opemergency.trorder    </para>    
    /// <para>类 名 称 :  TrOrderApbtView					</para> 
    /// <para>版 本 号 :  v1.0.0.0           			</para> 
    /// <para>作    者 :  qzwang         				</para> 
    /// <para>修 改 人 :  qzwang         				</para> 
    /// <para>创建时间 :  7/28/2016 5:15:56 PM             </para>
    /// <para>更新时间 :  7/28/2016 5:15:56 PM             </para> 
    /// <para>Copyright @ 北大医信（IIH项目组） 2016. All rights reserved.</para> 
    /// </summary>
    public class TrOrderApbtView : EmsApbtViewCard
    {
        public TrOrderApbtView(IEventDelegate o = null)
            : base(o)
        { }
