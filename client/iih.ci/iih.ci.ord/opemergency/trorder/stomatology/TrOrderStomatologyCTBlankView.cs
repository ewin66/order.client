...
namespace iih.ci.ord.opemergency.trorder
{
    ...
    /// </summary>
    public class TrOrderStomatologyCTBlankView : TrOrderBaseView
    {
        public TrOrderStomatologyCTBlankView(IEventDelegate owner = null)
            : base(owner)
        {
        }
        ...
        protected override BaseEmsView CreateEmsCardView(IEventDelegate owner = null)
        {
            ...
            return new EmsStomatologyCTBlankViewCard(owner);
        }
