...
namespace iih.ci.ord.opemergency.trorder
{
    ...
    /// </summary>
    public class TrOrderStomatologyCTView : TrOrderBaseView
    {
        public TrOrderStomatologyCTView(IEventDelegate owner = null)
            : base(owner)
        {
        }
        ...
        protected override BaseEmsView CreateEmsCardView(IEventDelegate owner = null)
        {
            ...
            return new EmsStomatologyCTViewCard(owner);
        }
