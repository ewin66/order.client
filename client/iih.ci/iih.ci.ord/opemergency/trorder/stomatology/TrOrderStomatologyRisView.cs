...
namespace iih.ci.ord.opemergency.trorder
{
    ...
    /// </summary>
    public class TrOrderStomatologyRisView : TrOrderBaseView
    {
        public TrOrderStomatologyRisView(IEventDelegate owner = null)
            : base(owner)
        {
        }
        ...
        protected override BaseEmsView CreateEmsCardView(IEventDelegate owner = null)
        {
            ...
            return new EmsStomatologyRisViewCard(owner);
        }
