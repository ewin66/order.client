...
namespace iih.ci.ord.opemergency.trorder
{
    ...
    /// </summary>
    public class TrOrderStomatologyUltrasonicDiagView : TrOrderBaseView
    {
        public TrOrderStomatologyUltrasonicDiagView(IEventDelegate owner = null)
            : base(owner)
        {
        }
        ...
        protected override BaseEmsView CreateEmsCardView(IEventDelegate owner = null)
        {
            ...
            return new EmsStomatologyUltrasonicDiagViewCard(owner);
        }
