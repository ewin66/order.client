...
namespace iih.ci.ord.opemergency.trorder
{
    ...
    /// </summary>
    public class TrOrderStomatologyXRayPerspectiveView : TrOrderBaseView
    {
        ...
        {
            //this.GetTableViewControl().GetXapFormControl().AllowEditing += TrOrderXRayView_AllowEditing;
            return new EmsStomatologyXRayPerspectiveViewCard(owner);
        }

        //void TrOrderXRayView_AllowEditing(object sender, xap.rui.control.formcontrol.model.AllowEditingEventArgs e)
        //{
