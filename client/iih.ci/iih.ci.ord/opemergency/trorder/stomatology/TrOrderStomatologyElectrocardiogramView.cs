...
namespace iih.ci.ord.opemergency.trorder
{
    ...
    /// </summary>
    public class TrOrderStomatologyElectrocardiogramView : TrOrderBaseView
    {
        public TrOrderStomatologyElectrocardiogramView(IEventDelegate owner = null)
            : base(owner)
        {
        }
        ...
        protected override BaseEmsView CreateEmsCardView(IEventDelegate owner = null)
        {
            ...
            return new EmsStomatologyElectrocardiogramViewCard(owner);
        }
