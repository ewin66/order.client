...
{
    public partial class OpippathgyDateTreeView : XapListControl, IWorkStationRegist
    {
        //public PatiVisitDO patDo = new PatiVisitDO();
        public Ent4BannerDTO ent4BannerDto;
        private LabDateTreeModel model;

        public OpippathgyDateTreeView()
        {
            InitializeComponent();
        ...
        protected override void OnLoadData()
        {
            ...
            if (ent4BannerDto != null && ent4BannerDto.Id_ent != null)
                model = new LabDateTreeModel(ent4BannerDto.Id_ent, "pathol");
        }
