...
/**
 * Xray数字化牙片检查申请单主 DTO数据 
 * 
 */
public class EmsStomatologyDigitizationToothViewDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getToothmap() {
		return ((String) getAttrVal("Toothmap"));
	}
	/**
	 * 牙位图（def1）
	 * @param Toothmap
	 */
	public void setToothmap(String Toothmap) {
		setAttrVal("Toothmap", Toothmap);
	}
	/**
	 * sv
	 * @return String
