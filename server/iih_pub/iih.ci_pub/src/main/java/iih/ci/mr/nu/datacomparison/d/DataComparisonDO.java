package iih.ci.mr.nu.datacomparison.d;
...
import iih.ci.mr.nu.datacomparison.d.desc.DataComparisonDODesc;
 ...
 * 
 */
public class DataComparisonDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_DC= "Id_dc";
	...
	public String getId_dc() {
		return ((String) getAttrVal("Id_dc"));
	}	
	public void setId_dc(String Id_dc) {
		setAttrVal("Id_dc", Id_dc);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(DataComparisonDODesc.class);
	}
