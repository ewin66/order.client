...
public interface ISkintestRService {
	...
	*/	
	...
	/**
	 * 根据condition条件及管控查找皮试结果记录数据集合
	 */
//	public abstract CiSkinTestRstDO[] findByBDMode(String whereStr,String orderStr,FBoolean isLazy) throws BizException;
	...
	*/
	 ...
	 */
//	public abstract PagingRtnData<CiSkinTestRstDO> findByPageInfoAndBDMode(PaginationInfo pg, String whereStr,String orderStr) throws BizException;
