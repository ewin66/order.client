 ...
 * 
 */
public class CiEmsSrvDTO extends BaseDTO {
	 ...
	 * @return FBoolean
	 */
	public String getDes_bl() {
		return ((String) getAttrVal("Des_bl"));
	}	
	/**
	 * 费用说明
	 * @param Fg_feertnable
	 */
	public void Des_bl(String Des_bl) {
		setAttrVal("Des_bl", Des_bl);
	}
	/**
	 * 外配药标识
	 * @return FBoolean
	 ...
	 * @return FArrayList
	 */
	public FArrayList getBdHpIndication() {
		return ((FArrayList) getAttrVal("BdHpIndication"));
	}	
	/**
	 * 医保校验结果
	 * @param BdHpIndication
	 */
	public void setBdHpIndication(FArrayList BdHpIndication) {
		setAttrVal("BdHpIndication", BdHpIndication);
	}
}