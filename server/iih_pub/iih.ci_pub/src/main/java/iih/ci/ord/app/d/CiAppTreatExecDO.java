 ...
 * 
 */
public class CiAppTreatExecDO extends BaseDO {
	...
	public static final String ID_APPTREATEXECTP= "Id_apptreatexectp";
	public static final String SD_APPTREATEXECTP= "Sd_apptreatexectp";
	...
	public String getId_apptreatexectp() {
		return ((String) getAttrVal("Id_apptreatexectp"));
	}	
	public void setId_apptreatexectp(String Id_apptreatexectp) {
		setAttrVal("Id_apptreatexectp", Id_apptreatexectp);
	}
	public String getSd_apptreatexectp() {
		return ((String) getAttrVal("Sd_apptreatexectp"));
	}	
	public void setSd_apptreatexectp(String Sd_apptreatexectp) {
		setAttrVal("Sd_apptreatexectp", Sd_apptreatexectp);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(CiAppTreatExecDODesc.class);
	}
