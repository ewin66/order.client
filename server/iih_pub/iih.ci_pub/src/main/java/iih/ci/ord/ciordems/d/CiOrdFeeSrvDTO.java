 ...
 * 
 */
public class CiOrdFeeSrvDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getFee_code_or() {
		return ((String) getAttrVal("Fee_code_or"));
	}
	/**
	 * 费用编码
	 * @param Code_or
	 */
	public void setFee_code_or(String Fee_code_or) {
		setAttrVal("Fee_code_or", Fee_code_or);
	}
	/**
	 * 医嘱内容
	 * @return String
