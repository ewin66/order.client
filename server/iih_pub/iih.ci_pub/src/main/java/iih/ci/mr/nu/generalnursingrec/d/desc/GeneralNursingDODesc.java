 ...
 * 一般护理记录主实体 DO 元数据信息
 */
public class GeneralNursingDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.generalnursingrec.d.GeneralNursingDO";
	public static final String CLASS_DISPALYNAME = "一般护理记录主实体";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_NU_GNR";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_gnr";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_gnrADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_gnrCDesc(tblDesc));
	...
	private IAttrDesc getCode_amr_ipADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"pi_pat a0b4","id_pat=id_pat","code_amr_ip"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
