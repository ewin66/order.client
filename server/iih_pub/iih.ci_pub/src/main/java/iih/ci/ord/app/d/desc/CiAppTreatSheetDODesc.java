 ...
 * 诊疗申请单 DO 元数据信息
 */
public class CiAppTreatSheetDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.app.d.CiAppTreatSheetDO";
	public static final String CLASS_DISPALYNAME = "诊疗申请单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_app_treat";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ciapptreatsheet";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ciapptreatsheetADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ciapptreatsheetCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_ciapptreatsheet");
