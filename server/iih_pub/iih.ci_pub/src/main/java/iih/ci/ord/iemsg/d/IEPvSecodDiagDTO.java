 ...
 * 
 */
public class IEPvSecodDiagDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getId_iepvseconddiag() {
		return ((String) getAttrVal("Id_iepvseconddiag"));
	}	
	/**
	 * ie就诊次要诊断主键标识
	 * @param Id_iepvseconddiag
	 */
	public void setId_iepvseconddiag(String Id_iepvseconddiag) {
		setAttrVal("Id_iepvseconddiag", Id_iepvseconddiag);
	}
	/**
	 * ie就诊主诊断主键标识
	 * @return String
