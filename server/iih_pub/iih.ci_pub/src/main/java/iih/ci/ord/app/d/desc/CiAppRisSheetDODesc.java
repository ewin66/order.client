 ...
 * 检查打印申请单 DO 元数据信息
 */
public class CiAppRisSheetDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.app.d.CiAppRisSheetDO";
	public static final String CLASS_DISPALYNAME = "检查打印申请单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_app_ris";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ciapprissheet";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ciapprissheetADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ciapprissheetCDesc(tblDesc));
	...
	private IAttrDesc getName_ppsADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b21","id_pps=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
