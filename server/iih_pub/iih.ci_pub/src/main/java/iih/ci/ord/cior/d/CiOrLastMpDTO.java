 ...
 * 
 */
public class CiOrLastMpDTO extends BaseDTO {
	 ...
	 * @return Integer
	 */
	public Integer getEu_last() {
		return ((Integer) getAttrVal("Eu_last"));
	}
	/**
	 * 是否最后一顿
	 * @param Eu_last
	 */
	public void setEu_last(Integer Eu_last) {
		setAttrVal("Eu_last", Eu_last);
	}
	/**
	 * 就诊类型
	 * @return String
