 ...
 * 患者信息 DO 元数据信息
 */
public class BirthrecInfoDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.obstetrics.birthrec.d.BirthrecInfoDO";
	public static final String CLASS_DISPALYNAME = "患者信息";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "CI_MR_NU_BIRTHINFO";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_birthinfo";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_birthinfoADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_birthinfoCDesc(tblDesc));
		...
		tblDesc.add(getBqCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getBqADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Bq",  getBqCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IColumnDesc getBqCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Bq");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("病区"); 
