...
public class KnowledgeDO extends BaseDO {
	...
	public static final String ID_KNOWLEDGE= "Id_knowledge";
	...
	public static final String KNOWLEDGE_TYPE_NAME= "Knowledge_type_name";
	...
	public String getKnowledge_type_name() {
		return ((String) getAttrVal("Knowledge_type_name"));
	}	
	public void setKnowledge_type_name(String Knowledge_type_name) {
		setAttrVal("Knowledge_type_name", Knowledge_type_name);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(KnowledgeDODesc.class);
	}
