...
/**
 * 新生儿科PICC护理记录单 DO 元数据信息
 */
public class NewBabyPiccDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.newbabypicc.d.NewBabyPiccDO";
	public static final String CLASS_DISPALYNAME = "新生儿科PICC护理记录单";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_nu_picc";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_picc";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_piccADesc(tblDesc));
		...
		this.add(getId_puncture_siteADesc(tblDesc));
		this.add(getSd_puncture_siteADesc(tblDesc));
		...
		this.add(getName_puncture_siteADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_piccCDesc(tblDesc));
		...
		tblDesc.add(getId_puncture_siteCDesc(tblDesc));
		tblDesc.add(getSd_puncture_siteCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_puncture_siteADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_puncture_site",  getId_puncture_siteCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_puncture_siteADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_puncture_site",  getSd_puncture_siteCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	...
	private IAttrDesc getName_patADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"en_ent a0b7","id_ent=id_ent","name_pat"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_operatorADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_psndoc a0b6","operator=id_psndoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_puncture_siteADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_puncture_site",  getName_puncture_siteCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("穿刺部位");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b8","id_puncture_site=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getName_result_cultureADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a0b9","id_result_culture=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_puncture_siteCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_puncture_site");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getSd_puncture_siteCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_puncture_site");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getName_puncture_siteCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_puncture_site");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("穿刺部位"); 
		return column;
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_picc");
