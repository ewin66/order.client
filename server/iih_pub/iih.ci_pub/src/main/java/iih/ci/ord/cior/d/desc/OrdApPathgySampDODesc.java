 ...
 * 病理标本 DO 元数据信息
 */
public class OrdApPathgySampDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.cior.d.OrdApPathgySampDO";
	public static final String CLASS_DISPALYNAME = "病理标本";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_pathgy_samp";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_appathgysamp";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_appathgysampADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_appathgyADesc(tblDesc));
		this.add(getId_appathgysampADesc(tblDesc));
		this.add(getId_appathgyADesc(tblDesc));
		this.add(getName_labsampADesc(tblDesc));
		this.add(getId_body_collADesc(tblDesc));
		this.add(getSd_body_collADesc(tblDesc));
		this.add(getBody_collADesc(tblDesc));
		this.add(getQuan_collADesc(tblDesc));
		this.add(getId_fixativeADesc(tblDesc));
		this.add(getSd_fixativeADesc(tblDesc));
		...
		this.add(getName_body_collADesc(tblDesc));
		this.add(getName_fixativeADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_appathgysampCDesc(tblDesc));
		tblDesc.add(getId_appathgysampCDesc(tblDesc));
		tblDesc.add(getId_appathgyCDesc(tblDesc));
		tblDesc.add(getName_labsampCDesc(tblDesc));
		tblDesc.add(getId_body_collCDesc(tblDesc));
		tblDesc.add(getSd_body_collCDesc(tblDesc));
		tblDesc.add(getBody_collCDesc(tblDesc));
		tblDesc.add(getQuan_collCDesc(tblDesc));
		tblDesc.add(getId_fixativeCDesc(tblDesc));
		tblDesc.add(getSd_fixativeCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_appathgysampADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_appathgysamp",  getId_appathgysampCDesc(tblDesc), this);
	 ...
	 * @return
	 */
	private IAttrDesc getId_body_collADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_body_coll",  getId_body_collCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本采集部位id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_body_collADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_body_coll",  getSd_body_collCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本采集部位sd");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getId_fixativeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_fixative",  getId_fixativeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本固定液id");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getSd_fixativeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Sd_fixative",  getSd_fixativeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本固定液sd");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IAttrDesc getName_body_collADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_body_coll",  getName_body_collCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本采集部位名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b5","id_body_coll=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IAttrDesc getName_fixativeADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Name_fixative",  getName_fixativeCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("标本固定液名称");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b6","id_fixative=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_appathgysampCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_appathgysamp");
		column.setLength(20);
	 ...
	 * @return
	 */
	private IColumnDesc getId_body_collCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_body_coll");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本采集部位id"); 
		return column;
	}
	/**
	 * 获取标本采集部位sd表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_body_collCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_body_coll");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本采集部位sd"); 
		return column;
	}
	/**
	 * 获取采集部位表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getId_fixativeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_fixative");
		column.setLength(20);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本固定液id"); 
		return column;
	}
	/**
	 * 获取标本固定液sd表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getSd_fixativeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Sd_fixative");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本固定液sd"); 
		return column;
	}
	/**
	 * 获取固定液表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_body_collCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_body_coll");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本采集部位名称"); 
		return column;
	}
	/**
	 * 获取标本固定液名称表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getName_fixativeCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Name_fixative");
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("标本固定液名称"); 
		return column;
	}
	/**
	 * 获取名称表列元数据
