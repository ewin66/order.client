...
* 妇产科护理观察记录数据维护服务
*/
public interface IAdhNursingRecDOCudService {
	/**
	*  妇产科护理观察记录数据真删除
	*/
	...
	*/
	 ...
	 */
	public AdhNursingRecDO[] enableWithoutFilter(AdhNursingRecDO[] aggdos) throws BizException ;

	/**
	 * 批量启用：可部分启用成功；
	 * 启用成功的记录可通过返回值的getDos方法得到，启用不成功的记录附加日志可通过返回值的getErrLogList方法得到
	 */
	public DOWithErrLog enableDO(AdhNursingRecDO[] aggdos) throws BizException ;

	/**
	 * 批量停用：要不全部都停用；或者出现异常，停用全部失败
	 */
	public AdhNursingRecDO[] disableVOWithoutFilter(AdhNursingRecDO[] aggdos) throws BizException;
	 ...
	 */
	public DOWithErrLog disableDO(AdhNursingRecDO[] aggdos) throws BizException ;
