 ...
 * 
 */
public class EmsPathgyPKUViewDTO extends BaseDTO {
	 ...
	 * @return FDateTime
	 */
	public FDateTime getOpdate() {
		return ((FDateTime) getAttrVal("Opdate"));
	}
	/**
	 * 取内膜日期（def14)
	 * @param Opdate
	 */
	public void setOpdate(FDateTime Opdate) {
		setAttrVal("Opdate", Opdate);
	}
	/**
	 * 既往病理外院标识
	 * @return FBoolean
