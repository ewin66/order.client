...
* 临床医嘱数据维护服务
*/
public interface IOrdSrvDORService {
	/**
	*  根据id值查找临床医嘱数据
	*/	
	...
	*/
	 ...
	 * @throws BizException
	 */
	public abstract OrdSrvDO[] findByAttrValString(String attr, String value) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract OrdSrvDO[] findByAttrValStrings(String attr, String[] values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public abstract OrdSrvDO[] findByAttrValList(String attr, FArrayList values) throws BizException;
	 ...
	 * @throws BizException
	 */
	public PagingRtnData<OrdSrvDO> findByQCondAndPageInfo(QryRootNodeDTO qryRootNodeDTO,String orderStr,PaginationInfo pg) throws BizException;
}