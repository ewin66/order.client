 ...
 * 
 */
public class OperNuRecordDressDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_OPRCOD_DRESS= "Id_oprcod_dress";
	...
	public String getId_oprcod_dress() {
		return ((String) getAttrVal("Id_oprcod_dress"));
	}	
	public void setId_oprcod_dress(String Id_oprcod_dress) {
		setAttrVal("Id_oprcod_dress", Id_oprcod_dress);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(OperNuRecordDressDODesc.class);
	}
