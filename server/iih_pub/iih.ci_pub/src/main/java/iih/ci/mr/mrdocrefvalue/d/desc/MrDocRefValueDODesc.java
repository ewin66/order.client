...
package iih.ci.mr.mrdocrefvalue.d.desc;
 ...
 * 引用文书内容表 DO 元数据信息
 */
public class MrDocRefValueDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.mrdocrefvalue.d.MrDocRefValueDO";
	public static final String CLASS_DISPALYNAME = "引用文书内容表";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_doc_reference_value";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_docrefvalue";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_docrefvalueADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.add(getId_docrefvalueADesc(tblDesc));
		this.add(getId_grpADesc(tblDesc));
		this.add(getId_orgADesc(tblDesc));
		this.add(getId_entADesc(tblDesc));
		this.add(getId_elementADesc(tblDesc));
		this.add(getCode_elementADesc(tblDesc));
		this.add(getCode_data_elementADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_docrefvalueCDesc(tblDesc));
		tblDesc.add(getId_docrefvalueCDesc(tblDesc));
		tblDesc.add(getId_grpCDesc(tblDesc));
		tblDesc.add(getId_orgCDesc(tblDesc));
		tblDesc.add(getId_entCDesc(tblDesc));
		tblDesc.add(getId_elementCDesc(tblDesc));
		tblDesc.add(getCode_elementCDesc(tblDesc));
		tblDesc.add(getCode_data_elementCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_docrefvalueADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_docrefvalue",  getId_docrefvalueCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("主键标识");
	 ...
	 * @return
	 */
	private IAttrDesc getCode_elementADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_element",  getCode_elementCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
	 ...
	 * @return
	 */
	private IAttrDesc getCode_data_elementADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Code_data_element",  getCode_data_elementCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("卫生部数据元编码");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getId_docrefvalueCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_docrefvalue");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("主键标识"); 
		return column;
	}
	/**
	 * 获取所属集团表列元数据
	 ...
	 * @return
	 */
	private IColumnDesc getCode_elementCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_element");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
	 ...
	 * @return
	 */
	private IColumnDesc getCode_data_elementCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Code_data_element");
		column.setLength(50);
        column.setSqlType(Types.VARCHAR);
		column.setNullable(true);
		column.setLabel("卫生部数据元编码"); 
		return column;
	}
	/**
	 * 获取病历文书id表列元数据
