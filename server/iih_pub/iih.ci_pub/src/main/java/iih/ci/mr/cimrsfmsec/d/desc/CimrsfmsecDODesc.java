 ...
 * 医疗记录智能表单段落 DO 元数据信息
 */
public class CimrsfmsecDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.cimrsfmsec.d.CimrsfmsecDO";
	public static final String CLASS_DISPALYNAME = "医疗记录智能表单段落";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_sfmsec";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_mrtplsfmsec";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_mrtplsfmsecADesc(tblDesc));
		...
		this.add(getEu_sfmsecmdADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_mrtplsfmsecCDesc(tblDesc));
		...
		tblDesc.add(getEu_sfmsecmdCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getEu_sfmsecmdADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Eu_sfmsecmd",  getEu_sfmsecmdCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.Integer);
		attrDesc.setLabel("段落格式模式");
		attrDesc.setNullable(true);
		attrDesc.setPersistence(true);
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
	 ...
	 * @return
	 */
	private IColumnDesc getEu_sfmsecmdCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Eu_sfmsecmd");
		column.setLength(50);
        column.setSqlType(Types.INTEGER);
		column.setNullable(true);
		column.setLabel("段落格式模式"); 
		return column;
	}
	/**
	 * 获取启用标志表列元数据
