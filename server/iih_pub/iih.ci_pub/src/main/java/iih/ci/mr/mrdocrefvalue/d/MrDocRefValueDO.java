package iih.ci.mr.mrdocrefvalue.d;
 ...
 * 
 */
public class MrDocRefValueDO extends BaseDO {
	private static final long serialVersionUID = 1L;

	public static final String ID_DOCREFVALUE= "Id_docrefvalue";
	public static final String ID_GRP= "Id_grp";
	public static final String ID_ORG= "Id_org";
	public static final String ID_ENT= "Id_ent";
	public static final String ID_ELEMENT= "Id_element";
	public static final String CODE_ELEMENT= "Code_element";
	public static final String CODE_DATA_ELEMENT= "Code_data_element";
	...
	public String getId_docrefvalue() {
		return ((String) getAttrVal("Id_docrefvalue"));
	}	
	public void setId_docrefvalue(String Id_docrefvalue) {
		setAttrVal("Id_docrefvalue", Id_docrefvalue);
	}
	...
	public String getCode_element() {
		return ((String) getAttrVal("Code_element"));
	}	
	public void setCode_element(String Code_element) {
		setAttrVal("Code_element", Code_element);
	}
	public String getCode_data_element() {
		return ((String) getAttrVal("Code_data_element"));
	}	
	public void setCode_data_element(String Code_data_element) {
		setAttrVal("Code_data_element", Code_data_element);
	}
...
//	}
	...
	public IDODesc getDODesc() {
		return DescManager.getInstance().getDODesc(MrDocRefValueDODesc.class);
	}
