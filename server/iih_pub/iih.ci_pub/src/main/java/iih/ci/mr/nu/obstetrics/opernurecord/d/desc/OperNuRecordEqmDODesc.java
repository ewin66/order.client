 ...
 * 手术室器材 DO 元数据信息
 */
public class OperNuRecordEqmDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.obstetrics.opernurecord.d.OperNuRecordEqmDO";
	public static final String CLASS_DISPALYNAME = "手术室器材";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_nu_oprcod_eqm";
	public static final String TABLE_ALIAS_NAME = "a1";
	public static final String PRIMARYKEY_FIELDNAME="Id_oprcod_eqm";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_oprcod_eqmADesc(tblDesc));
		this.setIBDDataInfoFldMap();
		this.setIAuditInfoFldMap();  
		this.setFKeyDesc(getId_oprcodADesc(tblDesc));
		this.add(getId_oprcod_eqmADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_oprcod_eqmCDesc(tblDesc));
		tblDesc.add(getId_oprcod_eqmCDesc(tblDesc));
	 ...
	 * @return
	 */
	private IAttrDesc getId_oprcod_eqmADesc(ITableDesc tblDesc){
		Attr attrDesc=new Attr("Id_oprcod_eqm",  getId_oprcod_eqmCDesc(tblDesc), this);
		attrDesc.setJavaType(FType.String);
		attrDesc.setLabel("手术室器材主键标识");
	...
	private IAttrDesc getName_tpADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b5","id_eqmtp=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	...
	private IAttrDesc getNameADesc(ITableDesc tblDesc){
		...
		attrDesc.setSerializable(true);
		attrDesc.setStatic(false);
		attrDesc.setRefTblInfos(new String[]{"bd_udidoc a1b6","id_eqm=id_udidoc","name"});
		attrDesc.setRefType(false);
		return attrDesc;
	}
	/**
	 ...
	 * @return
	 */
	private IColumnDesc getId_oprcod_eqmCDesc(ITableDesc tblDesc){
		ColumnDesc column=new ColumnDesc(tblDesc,"Id_oprcod_eqm");
		column.setLength(20);
        column.setSqlType(Types.CHAR);
		column.setNullable(true);
		column.setLabel("手术室器材主键标识"); 
		return column;
	}
	/**
	 * 获取手术护理记录单表列元数据
