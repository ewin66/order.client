...
package iih.ci.ord.obsordernoview.d.desc;
 ...
 * 检查申请单号 DO 元数据信息
 */
public class ObsOrderNoViewDesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.ord.obsordernoview.d.ObsOrderNoView";
	public static final String CLASS_DISPALYNAME = "检查申请单号";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "OBS_ORDERNO_VIEW";
