 ...
 * 
 */
public class EmsStomatologyElectrocardiogramViewDTO extends BaseDTO {
	 ...
	 * @return String
	 */
	public String getEegresult() {
		return ((String) getAttrVal("Eegresult"));
	}
	/**
	 * 心电图结果（def1）
	 * @param Eegresult
	 */
	public void setEegresult(String Eegresult) {
		setAttrVal("Eegresult", Eegresult);
	}
	/**
	 * sv
	 * @return String
