...
public class CriticalillDODesc extends DODesc {
	public static final String CLASS_FULLNAME = "iih.ci.mr.nu.criticalillrec.d.CriticalillDO";
	public static final String CLASS_DISPALYNAME = "危重症记录单主实体";
	public static final String CLASS_RESID = "";
	public static final String CLASS_RESMODULE = "";
	public static final String TABLE_NAME = "ci_mr_nu_ctri";
	public static final String TABLE_ALIAS_NAME = "a0";
	public static final String PRIMARYKEY_FIELDNAME="Id_ctri";
	...
	private void init(){		
		...
		this.setKeyDesc(getId_ctriADesc(tblDesc));
	...
	private ITableDesc getTableDesc(){
		...
		tblDesc.setPrimaryKey(getId_ctriCDesc(tblDesc));
	...
	private void setIBDDataInfoFldMap(){
		...
		iBDDataInfoFldMap.put("id","Id_ctri");
