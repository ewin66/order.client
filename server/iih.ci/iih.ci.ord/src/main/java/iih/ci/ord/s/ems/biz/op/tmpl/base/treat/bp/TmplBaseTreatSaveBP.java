package iih.ci.ord.s.ems.biz.op.tmpl.base.treat.bp;
 ...
 *
 */
public class TmplBaseTreatSaveBP extends EmsSetSaveBP {

	
	public TmplBaseTreatSaveBP() {
		// 设置有效性检查
	...
	protected int GetSrvObjStatus(Object uiModel) {
		...
		List<Object> listUiModel = (List<Object>) uiModel;
		for (Object ui : listUiModel){
			OrderTmplDetailList detailList = (OrderTmplDetailList)ui;
			OrTplNItmDO doInfo = detailList.get(0);
			status = doInfo.getStatus();
		}
		return status;
	}
