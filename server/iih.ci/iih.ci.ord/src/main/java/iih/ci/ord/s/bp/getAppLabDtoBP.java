 ...
 *
 */
public class getAppLabDtoBP {
	
	public static getAppLabDtoBP instance;
	private getAppLabDtoBP(){};
	public static getAppLabDtoBP getInstance()throws BizException{
		if(instance== null){
			instance = new getAppLabDtoBP();
		}
		return instance;
	}
	 ...
	 private String getSql(String condition){
		...
		sb.append(" inner join ci_ap_lab lab on lab.id_or = ci_order.id_or  ");   
