...
public class FireOpAgainDelEvent4IeBP extends AbstractOrSignListener {
	...
	public void doAction(IBusinessEvent event) throws BizException {
		...
		OrdBizLogger.info(ctx, "[FireOpAgainDelEvent4IeBP]医嘱重分方时删除集成平台事件逻辑开始");
	...
	private void fireEvent4Pharm(Hashtable<String, String> htors8ieevent, String ieEventType) throws BizException {
		...
		BaseDTO[] msgdos = bp.exec(htors8ieevent.get(ICiIEEventConst.EVENT_IE_CIOR_OP_DRUG_WC),
				htors8ieevent.get(ICiIEEventConst.EVENT_IE_CIOR_OP_DRUG_HERB),
				htors8ieevent.get(ICiIEEventConst.EVENT_IE_ID_ENT));
	...
	private void fireEvent4Op(Hashtable<String, String> htors8ieevent, String ieEventType) throws BizException {
		...
		for (BaseDTO d : msgdos) {
			...
			if (ieopdto.getAdmit_times() == null || ieopdto.equals("")) {
				mbx.setEntimes(0);
			} else {
