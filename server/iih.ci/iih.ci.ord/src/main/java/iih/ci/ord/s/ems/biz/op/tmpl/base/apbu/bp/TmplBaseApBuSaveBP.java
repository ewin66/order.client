package iih.ci.ord.s.ems.biz.op.tmpl.base.apbu.bp;
...
import iih.ci.ord.s.ems.biz.op.ems.apbu.EmsApBuValidate;
import iih.ci.ord.s.ems.biz.op.ems.def.DefaultApBuCreateOrderInfo;
...
public class TmplBaseApBuSaveBP extends EmsBaseSaveBP {

	public TmplBaseApBuSaveBP() {
		super();
		// 设置有效性检查
		setEmsValidate(new EmsApBuValidate());
		// 设置医嘱默认生成逻辑
		setDefaultCreateOrderInfo(new DefaultApBuCreateOrderInfo());
	}
