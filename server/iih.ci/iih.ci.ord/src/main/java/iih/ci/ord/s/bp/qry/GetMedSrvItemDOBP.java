 ...
 */
public class GetMedSrvItemDOBP implements ITransQry {
    
	private String _id_srv_set = "";
	public GetMedSrvItemDOBP(){}
	public GetMedSrvItemDOBP(String id_srv_set){
	...
	protected String getSql(){
		return "    "
                ...
                +"   def.id_srv_itm = bdsrv.id_srv  and   def.fg_clinical ='Y'  and   def.id_srv = '"+_id_srv_set+"'";
	}
}
