 ...
 *
 */
public class getAllAppByIdPatBP {

	
	 public static getAllAppByIdPatBP instance;
	 private getAllAppByIdPatBP(){};
	 public static getAllAppByIdPatBP getInstance()throws BizException{
		 if(instance == null){
			instance = new getAllAppByIdPatBP(); 
		 }
		 return instance;
	 }
	 ...
	 * @throws BizException
	 */
	public  AppObsDto[] getAllAppRequisitionByIdPatBP(EnappointmentDTO enappointmentDTO)throws BizException{
        //li_cheng 增加管控
	...
	private StringBuffer getSql(EnappointmentDTO enappointmentDTO)throws BizException{
		 ...
		 StringBuffer condition =  new StringBuffer();
			  ...
			  if(enappointmentDTO.getId_pat() != null && enappointmentDTO.getId_pat().size() >0){
	    		  condition.append(" and CI_ORDER.id_pat in (") ;
	    		  condition.append(CiOrdUtils.getMapConveretstr(enappointmentDTO.getId_pat()));
	    		  condition.append(")");
	    	  }
			  if(enappointmentDTO.getId_ent() != null){
	    		  condition.append(" and CI_ORDER.id_en ='") ;
	    		  condition.append(enappointmentDTO.getId_ent());
	    		  condition.append("'");
	    	  }
			  if(enappointmentDTO.getId_emp_sign() != null){
	    		  condition.append(" and CI_ORDER.id_emp_sign ='") ;
	    		  condition.append(enappointmentDTO.getId_emp_sign());
	    		  condition.append("'");
	    	  }
