 ...
 *
 */
public class DefaultOprCreateOrderInfo extends DefaultBaseCreateOrderInfo {
	...
	public OrderPackageInfo[] createOrderPakageInfo(CiEnContextDTO ctx, DefaultCreateParam[] szParam) throws BizException {
		...
		MedSrvOpDO[] srvopdos= ServiceFinder.find(IMedSrvOpDORService.class).findByAttrValStrings("Id_srv", 
