package iih.ci.ord.s.ems.biz.op.tmpl.std.ortmpl.drugs.bp;
...
import iih.ci.ord.s.ems.biz.op.tmpl.base.drugs.bp.TmplBaseDrugsSaveBP;
 ...
 *
 */
public class TmplDrugsSaveBP extends TmplBaseDrugsSaveBP {
	...
	protected void mergeOrderInfo(CiEnContextDTO ctx, CiOrderDO orderInfo, Object uiModel) throws BizException {
		OrTmplDO drugItem = (OrTmplDO) uiModel;
		//by yzh 添加医嘱付数
