package iih.ci.ord.s.ems.biz.op.tmpl.std.ortmpl.cons.bp;
...
import iih.ci.ord.s.ems.biz.op.tmpl.base.cons.bp.TmplBaseConsSaveBP;
...
public class TmplConsSaveBP extends TmplBaseConsSaveBP {
	public TmplConsSaveBP() {
		super();
		// 设置有效性检查
