package iih.ci.ord.s.ems.biz.op.emsv1.apbt.bp;
...
import iih.ci.ord.s.ems.biz.op.ems.apbt.EmsApBtValidate;
 ...
 *
 */
public class EmsApBtSaveBP extends EmsBaseSaveBP {
	...
	public EmsApBtSaveBP() {
		super();
		// 设置有效性检查
		setEmsValidate(new EmsApBtValidate());
		// 设置医嘱默认生成逻辑
