...
public class EmsConsSaveBP extends EmsSingleSaveBP {
	public EmsConsSaveBP() {
		super();
		// 设置有效性检查
	...
	public EmsConsSaveBP(IEmsValidate emsValidate) {
...
//	}
	...
	protected void mergeOrderInfo(CiEnContextDTO ctx,CiOrderDO orderInfo, Object uiModel) throws BizException{
		...
		if (orderInfo.getFg_long() == FBoolean.TRUE
