...
/**
 * @ClassName: getRecipeByIdEntsQry
 * @Description: TODO
 * @author Comsys-li_zheng
 * @date 2016年8月25日 下午3:05:03
 * @Package iih.ci.ord.s.bp.qry
 * Copyright: Copyright (c) 2011 
 * Company: 北大医疗信息技术有限责任公司
 */
public class getRecipeByIdEntsQry implements ITransQry {
   private String _id_ents;
	public getRecipeByIdEntsQry(String[] id_ents){
	...
	private String getSql(){
		StringBuffer sb = new StringBuffer();
		 ...
		 sb.append("    where cipres.id_en in ("+this._id_ents+")");
	     return sb.toString();
	}
