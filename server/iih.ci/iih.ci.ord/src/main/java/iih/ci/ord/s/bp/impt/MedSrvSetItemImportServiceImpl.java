 ...
 *
 */
public class MedSrvSetItemImportServiceImpl extends BaseDataImport<MedSrvSetItemDO>
	...
	public boolean importData() throws BizException {
		...
		ServiceFinder.find(IMedSrvSetItemDOCudService.class).insert(dos);
	...
	public boolean cleanData() throws BizException {
		...
		daFacade.execUpdate("delete from "+new MedSrvSetItemDO().getTableName()+""+ " where "+new MedSrvSetItemDO().getPKFieldName() +" not like '@@@@%'");
		return true;
	}
