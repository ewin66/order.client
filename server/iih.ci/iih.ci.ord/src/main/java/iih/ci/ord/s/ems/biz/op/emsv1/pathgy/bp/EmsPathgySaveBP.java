...
public class EmsPathgySaveBP extends EmsBaseSaveBP {
...
//		// 编辑保存医嘱逻辑
//		for (Object uiModel : listUiModel) {
//			EmsPathgyItemDO itemDO = (EmsPathgyItemDO) uiModel;
//			
...
//			orderPakageInfo.setOrderInfo(orderAggInfo.getParentDO());
//			// 合并ui数据
//			mergeOrderInfo(ctx, orderPakageInfo.getOrderInfo(), itemDO);
//			for (OrdSrvDO srvInfo : orderAggInfo.getOrdSrvDO()) {
//				mergeOrderSrvInfo(ctx, srvInfo, itemDO);
//			}
//			// 设置医嘱服务列表信息
//			orderPakageInfo.setOrderSrvList(orderAggInfo.getOrdSrvDO());
//			// 查询申请单信息
//			CiorapppathgyAggDO[] pathgyAggDOInfo = CiOrdAppUtils.getOrapppathgyQryService().find(
//					" id_or ='" + itemDO.getId_or() + "'", "", FBoolean.FALSE);
//			orderApplySheetFrom(pathgyAggDOInfo[0], itemDO);
//			orderPakageInfo.setOrderAppSheetList(pathgyAggDOInfo);
//			
//			// 提取 医嘱对象
